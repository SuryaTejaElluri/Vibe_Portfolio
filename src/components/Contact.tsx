      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {email && email !== "<ADD_EMAIL>" && (
            <a
              href={`mailto:${email}`}
              className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.05] border border-gray-100 dark:border-slate-700 text-center group relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm break-all group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                  {email}
                </p>
              </div>
            </a>
          ...
          {/* GitHub */}
          {github && !github.includes("ADD_GITHUB") && github.startsWith("http") && (
            <a
              href={github.replace(/[<>]/g, "")}
              target="_blank"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">
                  View Profile
                </p>
              </div>
            </a>
          ...
          {/* LinkedIn */}
          {linkedin && !linkedin.includes("ADD_LINKEDIN") && linkedin.startsWith("http") && (
            <a
              href={linkedin.replace(/[<>]/g, "")}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.05] border border-gray-100 dark:border-slate-700 text-center group relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                  Connect
                </p>
              </div>
            </a>
